...
type Client interface {
	// Get a Service from consul_discover
...
// NewConsulClient returns a Client interface for given consul_discover address
...
// Register a service with consul_discover local agent
...
// DeRegister a service with consul_discover local agent
